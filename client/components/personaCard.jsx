      ...
      <div className={"card card-side bg-base-100 shadow-xl"}>
        <figure>
          ...
          <div className={"card-body"}>
              ...
              <p>Arbeid | 3D-generalist med fokus på karakterdesign for real-time rendering og spill, og .NET utvikler.
                  <br/>
                  <br/>

                  Utdanning | Fullført bachelorgrad innen 3D-grafikk. Pågående bachelorutdanning innen programmering</p>
              <ContactCard/>
          </div>
      </div>
    </div>
